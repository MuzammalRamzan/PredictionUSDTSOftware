...
async function main() {
  ...
  const bettingPool = await BettingPool.deploy(ocroTokenAddress, usdtTokenAddress);
  ...
  console.log(`   npx hardhat verify --network ${network} ${contractAddress} ${ocroTokenAddress} ${usdtTokenAddress}`);
